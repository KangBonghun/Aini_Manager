...
(function ($) {
    ...
    $.fn.fileinputLocales['kr'] = {
        ...
        msgInvalidFileType: '파일 "{name}"의 타입은 지원하지 않습니다. "{types}" 타입의 파일을 선택해 주십시오.',
        msgInvalidFileExtension: '파일 "{name}"의 확장자는 지원하지 않습니다. "{extensions}" 확장자 파일을 선택해 주십시오.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadEmpty: '업로드가 가능한 파일이 존재하지 않습니다.',
        ...
        dropZoneTitle: '파일을 여기에 끌어놓거나</br>파일선택 버튼을 클릭하십시오.',
        dropZoneClickTitle: '<br>(또는 {files} 선택을 위해 클릭하십시오.)',
        fileActionSettings: {
            removeTitle: '파일 지우기',
            ...
            indicatorSuccessTitle: '업로드가 성공했습니다.',
            indicatorErrorTitle: '업로드 중 에러가 발생했습니다.',
